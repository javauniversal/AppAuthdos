package com.zonaapp.appauthdos;
...
import static com.zonaapp.appauthdos.MainApplication.LOG_TAG;
    ...
    public static class AuthorizeListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            AuthorizationServiceConfiguration serviceConfiguration = new AuthorizationServiceConfiguration(
                    Uri.parse("https://pre-prod.id.tigo.com/oauth/v2/authorize") /* auth endpoint */,
                    Uri.parse("https://pre-prod.id.tigo.com/oauth/v2/accesstoken") /* token endpoint */
            );

            String clientId = "N842rCsSqqS3AtJhfqy3GasrhVeHuNGV";
            Uri redirectUri = Uri.parse("unetvandroidapp://tigoid/callback");
            ...
            //builder.setScopes(new String[] { "openid", "phone" });
            builder.setScopes("openid email");
            AuthorizationRequest request = builder.build();

            AuthorizationService authorizationService = new AuthorizationService(view.getContext());

            String action = "com.zonaapp.appauthdos.HANDLE_AUTHORIZATION_RESPONSE";
                    ...
                    new AsyncTask<String, Void, JSONObject>() {
                        ...
                        protected JSONObject doInBackground(String... tokens) {
                            ...
                            Request request = new Request.Builder()
                                    .url("https://pre-prod.id.tigo.com/oauth/v2/getdetails")
